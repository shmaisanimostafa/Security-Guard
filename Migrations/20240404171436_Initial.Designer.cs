...
namespace Security_Guard.Migrations
{
    ...
    [Migration("20240404171436_Initial")]
            ...
            modelBuilder.Entity("Security_Guard.Models.File", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 0,
                            DateTime = new DateTime(2024, 4, 4, 20, 14, 35, 867, DateTimeKind.Local).AddTicks(9254),
                            FileName = "Virus.pdf",
                            StatusMessage = "",
                            URL = "www.virus.com",
                            UserName = "Mostafa"
                        ...
                        {
                            Id = 1,
                            DateTime = new DateTime(2024, 4, 4, 20, 14, 35, 867, DateTimeKind.Local).AddTicks(9318),
                        ...
                        {
                            Id = 2,
                            DateTime = new DateTime(2024, 4, 4, 20, 14, 35, 867, DateTimeKind.Local).AddTicks(9324),
                            FileName = "potato.pdf",
                            StatusMessage = "",
                            URL = "www.potato.me",
                            UserName = "Mostafa"
                        ...
                        {
                            Id = 3,
                            DateTime = new DateTime(2024, 4, 4, 20, 14, 35, 867, DateTimeKind.Local).AddTicks(9329),
                            FileName = "Virus.pdf",
                            StatusMessage = "",
                            URL = "www.virus.com",
                            UserName = "Mostafa"
                        ...
                        {
                            Id = 4,
                            DateTime = new DateTime(2024, 4, 4, 20, 14, 35, 867, DateTimeKind.Local).AddTicks(9333),
                            FileName = "Malware.pdf",
                            StatusMessage = "",
                            URL = "www.malware.ar",
                            UserName = "Mostafa"
                        ...
                        {
                            Id = 5,
                            DateTime = new DateTime(2024, 4, 4, 20, 14, 35, 867, DateTimeKind.Local).AddTicks(9338),
                            FileName = "potato.pdf",
                            StatusMessage = "",
                            URL = "www.potato.me",
                            UserName = "Mostafa"
            ...
            modelBuilder.Entity("Security_Guard.Models.Link", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 0,
                            DateTime = new DateTime(2024, 4, 4, 20, 14, 35, 868, DateTimeKind.Local).AddTicks(121),
                            Status = "danger",
                            StatusMessage = "",
                        ...
                        {
                            Id = 1,
                            DateTime = new DateTime(2024, 4, 4, 20, 14, 35, 868, DateTimeKind.Local).AddTicks(132),
                            Status = "safe",
                            StatusMessage = "",
                            URL = "www.trojans.ar",
                            UserName = "Mostafa"
                        ...
                        {
                            Id = 2,
                            DateTime = new DateTime(2024, 4, 4, 20, 14, 35, 868, DateTimeKind.Local).AddTicks(141),
                            Status = "ambigious",
                            StatusMessage = "",
                            URL = "www.malosd.me",
                            UserName = "Mostafa"
