    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 0, new DateTime(2024, 4, 6, 17, 20, 49, 674, DateTimeKind.Local).AddTicks(9112), "Virus.pdf", "", "www.virus.com", "Mostafa" },
                    { 1, new DateTime(2024, 4, 6, 17, 20, 49, 674, DateTimeKind.Local).AddTicks(9166), "Malware.pdf", "", "www.malware.ar", "Mostafa" },
                    { 2, new DateTime(2024, 4, 6, 17, 20, 49, 674, DateTimeKind.Local).AddTicks(9169), "potato.pdf", "", "www.potato.me", "Mostafa" },
                    { 3, new DateTime(2024, 4, 6, 17, 20, 49, 674, DateTimeKind.Local).AddTicks(9173), "Virus.pdf", "", "www.virus.com", "Mostafa" },
                    { 4, new DateTime(2024, 4, 6, 17, 20, 49, 674, DateTimeKind.Local).AddTicks(9177), "Malware.pdf", "", "www.malware.ar", "Mostafa" },
                    { 5, new DateTime(2024, 4, 6, 17, 20, 49, 674, DateTimeKind.Local).AddTicks(9180), "potato.pdf", "", "www.potato.me", "Mostafa" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 0, new DateTime(2024, 4, 6, 17, 20, 49, 674, DateTimeKind.Local).AddTicks(9471), "danger", "", "www.pdf.com.lb.mu.edu", "Mostafa" },
                    { 1, new DateTime(2024, 4, 6, 17, 20, 49, 674, DateTimeKind.Local).AddTicks(9478), "safe", "", "www.trojans.ar", "Mostafa" },
                    { 2, new DateTime(2024, 4, 6, 17, 20, 49, 674, DateTimeKind.Local).AddTicks(9483), "ambigious", "", "www.malosd.me", "Mostafa" }
                });
